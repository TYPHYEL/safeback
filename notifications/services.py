...
def init_firebase():
    ...
    # Production : credentials Firebase stockés dans Render
    if firebase_json:
        try:
    ...
    if cred_path and os.path.exists(cred_path):
        ...
        print(
            'FIREBASE_CREDENTIALS_JSON not set and '
            'FIREBASE_CREDENTIALS file missing; Firebase not initialized'
        )
